...
let ALL_PROVIDERS: [AIProvider] = [
    AIProvider(id: "grok",     name: "Grok",     icon: "bolt.fill",                   color: Color(hex: "#1D9BF0"), models: [
    ...
    AIProvider(id: "chatgpt",  name: "ChatGPT",  icon: "sparkles",                    color: Color(hex: "#FFFFFF"), models: [
    ...
    AIProvider(id: "gemini",   name: "Gemini",   icon: "star.fill",                   color: Color(hex: "#4A90D9"), models: [
    ...
    AIProvider(id: "claude",   name: "Claude",   icon: "wand.and.stars",              color: Color(hex: "#CC8B3C"), models: [
    ...
    AIProvider(id: "mistral",  name: "Mistral",  icon: "wind",                        color: Color(hex: "#FF6B35"), models: [
    ...
    AIProvider(id: "deepseek", name: "DeepSeek", icon: "magnifyingglass.circle.fill", color: Color(hex: "#7B68EE"), models: [
    ...
    AIProvider(id: "llama",    name: "Llama",    icon: "hare.fill",                   color: Color(hex: "#9B59B6"), models: [
    ...
    AIProvider(id: "qwen",     name: "Qwen",     icon: "cpu.fill",                    color: Color(hex: "#E8A838"), models: [
